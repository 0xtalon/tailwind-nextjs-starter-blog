...
tags: ['SSTI','RCE']
draft: false
summary: 'Writeup do CTF Renderizer da Hacking Club.'
...
Ele diz que é um jinja2 , a gente pode deduzir que se trata de um SSTI (Server-Side Tempalte Injection), pra testar eu mandei um `{{7*7}}.`
