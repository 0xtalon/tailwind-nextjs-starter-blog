...
draft: false
summary: 'Aplicação possui vulnerabilidades de Execução Remota de Código no Apache APISIX (CVE-2022-24112) e escalonamento de privilégios via binário SUID "lua".'
